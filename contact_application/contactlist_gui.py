...
def load_gui(app):
    ...
    app.btn_add_person = tk.Button(app.action_frame, text="ADD", command=lambda: contactlist_func.add_person(app),relief=GROOVE, bg='#dcdcdc')
    app.btn_add_person.grid(row=0, column=0, pady=10)

    # EDIT button
    app.btn_edit_person = tk.Button(app.action_frame, text="EDIT", command=lambda: contactlist_func.edit_person(app),relief=GROOVE, bg='#dcdcdc')
    app.btn_edit_person.grid(row=0, column=0, pady=10, padx=5)
    app.btn_edit_person.grid_remove()
    # DELETE button
    app.btn_delete_person = tk.Button(app.action_frame, text="DELETE", command=lambda: contactlist_func.delete_person(app),relief=GROOVE, bg='#dcdcdc')
    app.btn_delete_person.grid(row=0, column=1, pady=10, padx=5)
    app.btn_delete_person.grid_remove()
    # CLEAR button
    app.btn_clear_form = tk.Button(app.action_frame, text="CLEAR", command=lambda: contactlist_func.clear_form(app),relief=GROOVE, bg='#dcdcdc')
